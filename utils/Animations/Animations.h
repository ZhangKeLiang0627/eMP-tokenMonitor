...
void lv_anim_drop_out(lv_obj_t *obj, uint16_t time = 550, uint16_t delay = 0, bool del = true, lv_coord_t x = -30, lv_coord_t y = 50);

void lv_anim_center_rotate(lv_obj_t *obj, int32_t angle = 3600, uint16_t time = 1000, uint16_t delay = 0);
